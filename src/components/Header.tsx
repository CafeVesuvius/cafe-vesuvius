...
function Header() {
    return (
        <Box sx={{flexGrow: 1}}>
                    ...
                    <Typography variant="h5" component="div" sx={{flexGrow: 1}}>
                        <div className="relative z-50 flex justify-between">
                            <div className="flex items-center md:gap-x-12">
                                ...
                                <a className="leading-0 translate-y-0.5 font-display font-bold text-xl ps-2 tracking-tight text-neutral-800"
                                   href="/">
                                    Café Vesuvius
                                </a>
            ...
            <span>
                Bestil bord <svg width="10" height="10" viewBox="0 0 10 10" aria-hidden="true"
                                 className="relative top-[1] ml-2 hidden fill-transparent stroke-white stroke-2 lg:inline"><g
                fill-rule="evenodd"><path className="opacity-0 transition-opacity group-hover:opacity-100"
                                          d="M0 5h7"></path><path
                className="transition-transform group-hover:translate-x-[3px]" d="M1 1l4 4-4 4"></path></g></svg>
            </span>
                                </a>
                            </div>
                        </div>
